    ...
    <div className="min-h-screen">
      ...
      <nav className="bg-blue-900 text-white py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center space-x-8 overflow-x-auto">
            ...
            <Link href="/youth-program" className="whitespace-nowrap text-blue-300 font-semibold">Youth Program</Link>
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Youth Program</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Building confidence, discipline, and technique for ages 4-12
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="#program-details" className="border-2 border-white hover:bg-white hover:text-blue-900 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <section id="program-details" className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Building Champions On and Off the Mats</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our Youth Program provides a safe, fun, and structured environment where children learn Brazilian Jiu-Jitsu fundamentals while developing essential life skills.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">What Makes Our Youth Program Special</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Techniques and drills designed specifically for young learners</p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Individual attention from expert instructors</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <Trophy className="h-6 w-6 text-blue-600 mt-1 mr-3 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Character Development</h4>
                    <p className="text-gray-600">Focus on respect, discipline, and perseverance</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Core Benefits</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Better Focus</h3>
              <p className="text-gray-600">Improved attention span and listening skills through structured training</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Self-Defense Skills</h3>
              <p className="text-gray-600">Practical techniques for personal safety and confidence</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Self-esteem and social skills development</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Strength, flexibility, and coordination improvement</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Belt promotion system teaches perseverance and goal-setting</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Respect & Discipline</h3>
              <p className="text-gray-600">Traditional martial arts values and character development</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Youth Program Schedule</h2>
            <p className="text-lg text-gray-600">Multiple class times available throughout the week</p>
          </div>

          <div className="bg-gray-50 rounded-lg p-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">Ages 4-8 (Little Warriors)</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="font-medium">Tuesday & Thursday</span>
                    <span className="text-blue-600">5:30 PM - 6:15 PM</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="font-medium">Saturday</span>
                    <span className="text-blue-600">10:00 AM - 10:45 AM</span>
                  </div>
                </div>
              </div>

              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">Ages 9-12 (Young Champions)</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="font-medium">Tuesday & Thursday</span>
                    <span className="text-blue-600">6:15 PM - 7:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="font-medium">Saturday</span>
                    <span className="text-blue-600">11:00 AM - 11:45 AM</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Start Your Child's Jiu-Jitsu Journey Today</h2>
          <p className="text-xl mb-8">
            Give your child the gift of confidence, discipline, and lifelong skills. Free trial class available!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book" className="bg-white text-blue-900 hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold transition-colors">
              Schedule Free Trial
            </Link>
            <a href="tel:+18324589839" className="border-2 border-white hover:bg-white hover:text-blue-900 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
              Call (832) 458-9839
            </a>
          </div>
        </div>
